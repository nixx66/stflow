...
import { getWalletNetworkLabel, shortenWalletAddress } from "@/lib/walletDisplay";
  ...
  return (
    <ConnectButton.Custom>
      {({ account, chain, mounted, openAccountModal, openChainModal, openConnectModal }) => {
        ...
        return (
          <button className={`${baseClass} ${height} ${toneClass}`} onClick={openAccountModal} type="button">
            <Wallet className="h-4 w-4" />
